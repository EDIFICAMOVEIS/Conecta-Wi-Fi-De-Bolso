    ...
    const features = [
      {
        ...
        description: 'Velocidade 4G/5G, downloads e videoconferências sem interrupções.',
        color: '#fbbf24'
      },
      {
        icon: 'shield-check',
      ...
      },
      {
        ...
        description: 'Conecte até 10 dispositivos simultaneamente.',
        color: '#8b5cf6'
      },
      {
        icon: 'map-pin',
        title: 'Cobertura Nacional',
        description: 'Acesso em todo o Brasil com as melhor operadora.',
        color: '#ec4899'
      },
      {
        icon: 'package',
      ...
      <section id="features" className="py-20 px-6 bg-white" data-name="features" data-file="components/Features.js">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Por Que Escolher o Conecta?</h2>
