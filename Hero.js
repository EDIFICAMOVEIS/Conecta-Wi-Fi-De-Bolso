          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-block px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm mb-6 shadow-sm">
                <span className="text-[var(--primary-color)] font-semibold">✨ Internet Rápida</span>
              </div>
              ...
              <div className="mt-12 flex items-center gap-8">
                <div>
                  <div className="text-3xl font-bold" style={{color: 'var(--primary-color)'}}>5K+</div>
                ...
                <div>
                  <div className="text-3xl font-bold" style={{color: 'var(--primary-color)'}}>24 Horas</div>
            ...
            <div className="relative">
              <div className="relative z-10">
                <img src="components/imagem/Design3.png" alt="Wi-Fi Portátil" className="rounded-3xl shadow-2xl"/>
              </div>
