function Plans({ openModal }) {
  try {
    const plans = [
      {
        name: '6GB de Internet',
        price: '69,90',
        period: 'mês',
        description: 'Ideal para uso leve',
        features: ['6GB de dados', 'Velocidade 4G', 'Suporte por email e Whatsapp'],
        popular: false,
        link: 'https://www.asaas.com/c/px999ktfxzpb6u55'
      },
      {
        name: '15GB de Internet',
        price: '84,90',
        period: 'mês',
        description: 'Para uso moderado',
        features: ['15GB de dados','Velocidade 4G/5G', 'Suporte prioritário'],
        popular: false,
        link: 'https://www.asaas.com/c/94a59m0l6pq3jg98'
      },
      {
        name: '20GB de Internet',
        price: '99,99',
        period: 'mês',
        description: 'Uso frequente',
        features: ['20GB de dados','Velocidade 5G', 'Suporte 24 Horas'],
        popular: false,
        link: 'https://www.asaas.com/c/epz56y4wsxs2f10f'
      },
      {
        name: '30GB de Internet',
        price: '114,99',
        period: 'mês',
        description: 'Melhor custo-benefício',
        features: ['30GB de dados','Velocidade 5G', 'Suporte prioritário 24 Horas'],
        popular: true,
        link: 'https://www.asaas.com/c/dv1341x7a7gyierq'
      },
      {
        name: '40GB de Internet',
        price: '129,99',
        period: 'mês',
        description: 'Para uso intenso',
        features: ['40GB de dados','Velocidade 5G+', 'Suporte dedicado'],
        popular: false,
        link: 'https://www.asaas.com/c/vypf7c0lseavv5um'
      },
      {
        name: '50GB de Internet',
        price: '144,99',
        period: 'mês',
        description: 'Alto consumo',
        features: ['50GB de dados','Velocidade 5G+', 'Suporte dedicado', 'Prioridade na rede'],
        popular: false,
        link: 'https://www.asaas.com/c/11szfm21fkleeuvk'
      },
      {
        name: '100GB de Internet',
        price: '159,99',
        period: 'mês',
        description: 'Uso profissional',
        features: ['100GB de dados','Velocidade 5G+', 'Suporte dedicado',],
        popular: false,
