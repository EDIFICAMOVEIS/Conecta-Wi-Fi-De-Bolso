    ...
    const testimonials = [
      {
        ...
        content: 'Trabalho viajando pelo Brasil e o Conect revolucionou minha vida profissional. Internet estável em qualquer lugar!',
        rating: 5
      },
      {
        name: 'João Santos',
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <div className="mb-8 flex justify-center">
              <img src="https://images.unsplash.com/photo-1551818255-e6e10975bc17?auto=format&fit=crop&w=300&q=80" alt="Roteador Conect" className="rounded-2xl shadow-xl w-48 h-48 object-cover"/>
            </div>
